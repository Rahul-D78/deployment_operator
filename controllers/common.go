...
func (r *AutomationReconciler) ensureDeployment(request ctrl.Request,
...
func (r *AutomationReconciler) ensureService(request reconcile.Request,
	instance *automation.Automation,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *AutomationReconciler) ensureSecret(request reconcile.Request,
	instance *automation.Automation,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func labels(v *automation.Automation, tier string) map[string]string {
